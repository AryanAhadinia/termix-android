...
public class ServeForgetPasswordActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable @org.jetbrains.annotations.Nullable Bundle savedInstanceState) {
        ...
        changePasswordButton.setOnClickListener(v -> {
            ...
            checkPassword(handler, passwordText);
            App.getExecutorService().execute(getChangePasswordTask(handler, passwordText));
        });
    }
    ...
    private void checkPassword(Handler handler, String password) {
    ...
    private ChangePasswordTask getChangePasswordTask(Handler handler, String passwordText) {
        return new ChangePasswordTask(passwordText) {
            @Override
            public void onResult(Object o) {
                handler.post(() -> {
                    ...
                    if (isTaskRoot()) {
                        ...
                        toast = Toast.makeText(getBaseContext(),
                                "گذرواژه دگرگون شد.", Toast.LENGTH_LONG);
                    }
                    toast.show();
                });
